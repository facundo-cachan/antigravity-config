...
- If detailed procedures are required, open `./references/implementation-playbook.md`.

## Resources

- `./references/implementation-playbook.md` for detailed audit steps, tooling, and remediation examples.
